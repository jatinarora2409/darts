...
parser.add_argument('--img_cropped_height', type=int, default=64, help='img cropped height')
parser.add_argument('--img_cropped_width', type=int, default=64, help='img cropped width')
...
def main():
  ...
  model = Network(args.init_channels, RANDOM_SHIT, args.layers, criterion,output_height=args.img_cropped_height,output_width=args.img_cropped_width)
  model = model.cuda()
